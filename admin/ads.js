...
(function () {
  ...
  /* Banners | Tiles | Ads | Announcements switch (Worlds/Fashion/Beauty moved to the Explore tab — see switchExploreSub) */
  window.switchBannerSub = function (which) {
    document.querySelectorAll('.bsub-tab').forEach(function (t) { if (t.dataset.sub) t.classList.toggle('on', t.dataset.sub === which); });
